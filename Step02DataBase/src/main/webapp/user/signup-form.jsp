...
<body>
	...
	<script>
		...
		*/
		...
		//비밀번호 혹은 비밀번호 확인 란에 입력했을 때 동일한 함수가 호출되도록 한다
		...
		document.querySelector("#email").addEventListener("input", (e)=>{
			...
			if(reg_email.test(email)){
				...
				//사용할 수 있는 이메일이라는 의미에서 true 를 넣어준다
				isEmailValid=true;
			}else{
				document.querySelector("#email").classList.add("is-invalid");
				//사용할 수 있는 이메일이라는 의미에서 false 를 넣어준다
				isEmailValid=false;
			}
			checkForm();
		});		
